resource "aws_cloudfront_origin_access_control" "lawly_origin_access_control" {
  name                              = var.oac_name
  description                       = "lawly access policy"
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  origin {
    ...
    origin_access_control_id = aws_cloudfront_origin_access_control.lawly_origin_access_control.id
